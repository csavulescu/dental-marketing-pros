...
- If PILLAR is GEO (AI search / generative engine optimisation): explain how AI assistants such as ChatGPT, Google AI Overviews, Gemini, Copilot and Perplexity find and use information accurately and cautiously. Do NOT claim insider knowledge of their ranking factors, do NOT promise that a practice will be cited or recommended, and present tactics as things that "can help" rather than guarantees. Also link to ${SITE_BASE}/free-seo-audit.html where a free audit is a natural next step.
